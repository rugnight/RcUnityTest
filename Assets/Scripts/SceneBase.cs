...
namespace RC {
    internal class SceneLoadTask : MonoBehaviour {
        ...
        IEnumerator CoTask() {
            yield return StartCoroutine(SceneTree.CoLoadScene(parent, sceneName, loadOption));
            GameObject.Destroy(gameObject);
        }
    }

    internal class SceneUnloadTask : MonoBehaviour {
    ...
    public class SceneTree {
        ...
        static public void LoadScene(Scene parent, string sceneName) {
            GameObject go = new GameObject("LoadScene " + sceneName);
        ...
        static public IEnumerator CoLoadScene(Scene parent, string sceneName, LoadOption loadOption = LoadOption.SceneEnd) {
            // ロード完了イベント登録
            bool bLoaded = false;
